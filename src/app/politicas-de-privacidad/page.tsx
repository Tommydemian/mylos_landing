...
export default function PoliticasDePrivacidadPage() {
				...
				>
					<section className="mb-12">
						...
						<ul className="list-disc list-inside text-base text-muted-foreground leading-relaxed mb-4 space-y-2 ml-4">
							...
							<li>
								Datos de integraciones: información sincronizada de TiendaNube,
								Mercado Libre, Shopify y AFIP
							</li>
						</ul>
					</section>
	...
	(
		<section className="mb-12">
			...
			<p className="text-base text-muted-foreground leading-relaxed mb-4">
				...
				Estas cookies nos permiten mantener tu sesión activa y recordar tus
				preferencias.
			</p>
		</section>
	) < section;
	className =
		...
		p;
	className = "text-base text-muted-foreground leading-relaxed mb-4" > Para;
	ejercer;
	tus;
	derechos;
	o;
